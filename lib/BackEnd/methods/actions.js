...
var functions = {
    ...
    addMedicalLeave: function (req, res, next) {
        if ((!req.body.doc_email) || (!req.body.doc_name) || (!req.body.doc_spec_in) || (!req.body.user_name) || (!req.body.user_email) || (!req.body.issue_face)) {
            res.json({
                success: false,
            ...
            var MedLeaveRequest = Med({
                ...
                "issue_face": req.body.issue_face,
    ...
    updateMedRequest: function (req, res, next) {
        if ((!req.body.doc_name) || (!req.body.doc_email) || (!req.body.doc_spec_in) || (!req.body.user_name) || (!req.body.user_email) || (!req.body.user_branch) || (!req.body.user_rollno) || (!req.body.issue_face)) {
            res.json({
                success: false,
                msg: "Enter all fields"
            })
