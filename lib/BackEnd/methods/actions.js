...
var functions = {
    ...
    searchSlot: function (req, res, next) {
        AddSlot.find({ date: req.body.date }, function (err, user) {
            if (err) {
    ...
    updateSlot: function (req, res, next) {
        if ((!req.body.date) || (!req.body.slot) || (!req.body.start_time) || (!req.body.end_time) || (!req.body.doc_name) || (!req.body.doc_email) || (!req.body.doc_spec_in) || (!req.body.descreption) || (!req.body.app_booked) || (!req.body.user_name) || (!req.body.user_email)) {
            res.json({
                success: false,
                msg: "Enter all fields"
            })
